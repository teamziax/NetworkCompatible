...
/** Shared schema resource is generated by Warden's TS contract; no parallel JVM wire model. */
final class ProviderContract {
    private static final JsonObject SCHEMA;
    static {
        try (var in = ProviderContract.class.getResourceAsStream("/provider-registration-v0.schema.json")) {
